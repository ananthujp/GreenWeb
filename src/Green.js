...
function Green() {
  ...
  const logoImg ='https://englishtribuneimages.blob.core.windows.net/gallary-content/2020/7/Desk/2020_7$largeimg_2052329743.jpg'
    return (
      <div className="bg-purple-900">
        ...
        >
              ...
              <motion.h1
                ...
                animate="animate"
                exit="exit"
                className={"font-beb mt-20  text-transparent bg-clip-text bg-gradient-to-br from-purple-500 to-pink-300 mx-auto lg:text-8xl md:text-6xl text-6xl"}>Green</motion.h1>
              <motion.h1
                variants={animH2}
                initial="initial"
                animate="animate"
                exit="exit"
                className={"font-beb   text-transparent bg-clip-text bg-gradient-to-br from-purple-500 to-pink-300  mx-auto lg:text-6xl md:text-4xl text-2xl"}>Club</motion.h1>
              <div
               //animate={{ rotate: 180 }}
