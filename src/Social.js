...
const EmbedoItem = ({ id, name, href, ...props }) => {
  ...
  useEffect(() => {
    ...
    embedo.load(ref.current, href, options);
  }, [href]);
  return (
    <motion.a
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="w-4/5 mx-auto shadow-md "
      ref={ref}
      key={id}
      href={href}
    ></motion.a>
      ...
      <div className="w-full mt-12 flex flex-col ">
        <div className="flex flex-col w-3/4 md:w-1/2  mx-auto">
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="flex rounded-3xl w-full overflow-hidden bg-gray-50 border-2 border-gray-100  justify-between my-8"
          >
            <div
              onClick={() => setSocial("twitter")}
              className={
                "hover:bg-gray-100 cursor-pointer md:py-4 md:px-4 py-1 px-1 flex flex-row items-center justify-center " +
                (socialClr === "twitter" ? "bg-gray-200" : "bg-gray-50")
              }
            >
              <TwitterIcon />
            ...
            <div
              onClick={() => setSocial("insta")}
              className={
                "hover:bg-gray-100 cursor-pointer  md:py-4 md:px-4 py-1 px-1 flex flex-row items-center justify-center " +
                (socialClr === "insta" ? "bg-gray-200" : "bg-gray-50")
              }
            >
              <InstaIcon />
            ...
            <div
              onClick={() => setSocial("fb")}
              className={
                "hover:bg-gray-100 cursor-pointer md:py-4 md:px-4 py-1 px-1 flex flex-row items-center rounded-r-3xl justify-center" +
                (socialClr === "fb" ? "bg-gray-200" : "bg-gray-50")
              }
            >
              <FbIcon />
